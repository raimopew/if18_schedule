...
<ul>
	...
	<li>
		<a href="https://www.tlu.ee/asio/" class="special" target="_blank">ASIO</a> (https) | <a href="https://www.tlu.ee/asio/kalenterit2/index.php?cluokka=IFIFB-1&kt=lk&guest=intranet%2Ftu&lang=est" class="special" target="_blank">ASIO IFIF18 1.õ.-a.</a> (https)
	</li>
	<li>
		<a href="https://www.tlu.ee/masio/" class="special" target="_blank">mASIO</a> (https) | <a href="https://www.tlu.ee/masio/?id=ryhm&ryhm=IFIFB-1#mASIO" class="special" target="_blank">mASIO IFIF18 1.õ.-a.</a> (https)
	</li>
	<li>
		<a href="https://ois2.tlu.ee/" class="special" target="_blank">ÕIS</a> (https)
	</li>
	<li>
		<a id="hide40" href="#hide40" class="hide special">+ GitHub käsud (push)</a><a id="show40" href="#show40" class="show special">- GitHub käsud (push)</a>
		<div class="more">
			<p>git add .</p>
	...
	<li>
		<a id="hide41" href="#hide41" class="hide special">+ SQL info</a><a id="show41" href="#show41" class="show special">- SQL info</a><div class="more">
			<p><a href="http://greeny.cs.tlu.ee/phpMyAdmin" class="special" target="_blank">greeny.cs.tlu.ee/phpMyAdmin</a> (ainult tunneliga)</p>
	...
	<li>
		...
		<div class="more">
			<p><a href="http://caupo.ee/tlu/" class="special" target="_blank">http://caupo.ee/tlu/</a></p>
			...
			<p><a href="https://drive.google.com/drive/u/0/folders/16hDQYkxrAxfkkIYyaWXUOwvxAp4VpnH1" class="special" target="_blank">Caupo TLÜ Google Drive Shared</a></p>
